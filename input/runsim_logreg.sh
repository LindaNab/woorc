...
#SBATCH --output=/exports/clinicalepi/Linda/simexvsmecor/job%_logreg_scen_%a.out              # Output file name
#SBATCH --error=/exports/clinicalepi/Linda/simexvsmecor/job%_logreg_scen_%a.err               # Error file name
